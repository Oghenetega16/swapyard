...
export default function GoogleButton() {
  const handleSuccess = async (credentialResponse: any) => {
    ...
    if (res.ok) {
      ...
      setSuccessMsg("Successful login, redirecting to homepage")
    } else {
      const data = await res.json();
      setErrorMsg("Failed to login, you either don't have an account yet or try again")
    }
  };
