...
const NIGERIA_DATA = [
  ...
  { state: "FCT - Abuja", lgas: ["Abaji", "Bwari", "Gwagwalada", "Kuje", "Kwali", "Municipal Area Council"] },
  ...
  { state: "Osun", lgas: ["Atakunmosa East", "Atakunmosa West", "Ayedaade", "Ayedire", "Boluwaduro", "Boripe", "Ede North", "Ede South", "Egbedore", "Ejigbo", "Ife Central", "Ife East", "Ife North", "Ife South", "Ifedayo", "Ifelodun", "Ila", "Ilesa East", "Ilesa West", "Irepodun", "Irewole", "Isokan", "Iwo", "Obokun", "Odo Otin", "Ola Oluwa", "Olorunda", "Oriade", "Orolu", "Osogbo"] },
  ...
  { state: "Zamfara", lgas: ["Anka", "Bakura", "Birnin Magaji/Kiyaw", "Bukkuyum", "Bungudu", "Chafe", "Gummi", "Gusau", "Kaura Namoda", "Maradun", "Maru", "Shinkafi", "Talata Mafara", "Zurmi"] }
];
...
export const LocationFilter = ({ 
    ...
    const cities = useMemo(() => {
        const data = NIGERIA_DATA.find(d => d.state === state);
        return data ? [...data.lgas].sort() : [];
    }, [state]);
    ...
    return (
        <div className="mb-8">
            ...
            <div className="space-y-3">
                <select 
                    className="w-full text-sm border border-gray-300 rounded p-2 text-gray-600 outline-none focus:border-[#002147] bg-white cursor-pointer"
                    value={state}
                ...
                <select 
                    className="w-full text-sm border border-gray-300 rounded p-2 text-gray-600 outline-none focus:border-[#002147] bg-white cursor-pointer disabled:bg-gray-50 disabled:cursor-not-allowed"
                    value={city}
